...
class HargaKamarSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($dataKamar as $kamar) {
            ...
            // Tentukan deposit berdasarkan nama cluster
            $deposit = 500000; // default
            foreach ($depositMapping as $cluster => $nilai) {
                if (stripos($unit->nama_cluster, $cluster) !== false) {
                    $deposit = $nilai;
                    break;
                }
            }
