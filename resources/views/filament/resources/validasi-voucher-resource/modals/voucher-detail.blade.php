<div class="space-y-6">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-500">Nama Penghuni</label>
                <p class="mt-1 text-sm text-gray-900">{{ $record->penghuni->nama }}</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-500">Email</label>
                <p class="mt-1 text-sm text-gray-900">{{ $record->penghuni->email ?: 'Tidak ada email' }}</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-500">No. Telepon</label>
                <p class="mt-1 text-sm text-gray-900">{{ $record->penghuni->no_telepon ?: 'Tidak ada telepon' }}</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-500">Kamar</label>
                <p class="mt-1 text-sm text-gray-900">{{ $record->penghuni->kamar->nama ?? 'Tidak ada kamar' }}</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="relative pb-8">
                        <div class="relative flex space-x-3">
                            ...
                            <div class="min-w-0 flex-1 pt-1.5">
                                <div>
                                    <p class="text-sm text-gray-500">Voucher diberikan kepada penghuni</p>
