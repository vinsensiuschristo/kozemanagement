<x-filament::page>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-black dark:text-white">Status: <span class="font-semibold">{{ $record->status }}</span></p>
    </div>
    ...
    <div class="mb-8">
        ...
        @forelse ($this->getMessageHistory() as $message)
            <div class="mb-4 p-4 border border-gray-200 dark:border-gray-700 rounded bg-gray-50 dark:bg-gray-800 text-black dark:text-white">
                <div class="flex justify-between items-center mb-1">
                    <span class="text-sm font-medium text-black dark:text-white">
                        Admin - {{ $message->user->name ?? 'Pengguna' }}
                    </span>
