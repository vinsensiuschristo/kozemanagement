            ...
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">
                        Informasi Assign Voucher
                    </h3>
                    <div class="mt-2 text-sm text-blue-700">
                        <p>Gunakan halaman ini untuk memberikan voucher kepada penghuni. Voucher yang diberikan tidak memiliki masa kadaluarsa dan dapat digunakan kapan saja di mitra yang terkait.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">
                                    {{ \App\Models\PenghuniVoucher::count() }}
                                </dd>
                            </dl>
                        </div>
                    </div>
